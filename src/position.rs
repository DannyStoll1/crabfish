...
use crate::{bitboard::Bitboard, types::{BoardMap, CastlingRights, Color, Key, Piece, PieceType, Square}};
...
struct StateInfo
{
    ...
    materialKey: Key,
    pawnKey: Key,
    nonPawnMaterial: EnumMap<Color, Value>,
    castlingRights: int,
    rule50: int,
    pliesFromNull: int,
    epSquare: Square,
    ...
    blockersForKing: EnumMap<Color, Bitboard>,
    pinners: EnumMap<Color, Bitboard>,
    checkSquares: EnumMap<PieceType, Bitboard>,
    capturedPiece: Piece,
    repetition: int,
...
struct Position
{
    ...
    castlingRightsMask: BoardMap<u32>,
    castlingRookSquare: EnumMap<CastlingRights::COUNT, Square>,
    castlingPath: EnumMap<CastlingRights::COUNT, Bitboard>,
    st: *mut StateInfo,
    game_ply: u32,
    sideToMove: Color,
    chess960: bool,
